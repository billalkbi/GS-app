...
public class addAppointment_tech extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(addAppointment_tech.this, MainActivity_tech.class);
...
//date picker
        ...
        datePicked.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(addAppointment_tech.this, R.style.AppTheme_DatePickerDialog, new DatePickerDialog.OnDateSetListener() {
                    @Override
...
//time picker
        ...
        pickTimeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(addAppointment_tech.this,
...
//on submit
    ...
    private void goBack()
    {
        if (typeUser.equals("tech")){
            ...
            Toast.makeText(addAppointment_tech.this, "erreur", Toast.LENGTH_SHORT).show();
        }

    }

    private void showMainActivityAdmin() {
        Intent intent = new Intent(addAppointment_tech.this, MainActivity_admin.class);
        startActivity(intent);
        finish();
    }

    private void showMainActivity(){
        Intent intent = new Intent(addAppointment_tech.this, MainActivity.class);
        startActivity(intent);
        finish();
    }
    ...
    private void getCurrentLocation() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (ActivityCompat.checkSelfPermission(addAppointment_tech.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {

                if (isGPSEnabled()) {

                    LocationServices.getFusedLocationProviderClient(addAppointment_tech.this)
        ...
        result.addOnCompleteListener(new OnCompleteListener<LocationSettingsResponse>() {
            ...
            public void onComplete(@NonNull Task<LocationSettingsResponse> task) {
                ...
                try {
                    ...
                    Toast.makeText(addAppointment_tech.this, "GPS is already tured on", Toast.LENGTH_SHORT).show();
                    ...
                    switch (e.getStatusCode()) {
                        case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                            ...
                            try {
                                ...
                                resolvableApiException.startResolutionForResult(addAppointment_tech.this, 2);
