            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(addAppointment.this, R.style.AppTheme_DatePickerDialog, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                        ...
                        Toast.makeText(addAppointment.this, "your choice is " + dateChoice, Toast.LENGTH_SHORT).show();
...
// store picker
        ...
        storeSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(addAppointment.this, "your choice is " + storeChoice, Toast.LENGTH_SHORT).show();
            }
...
//reasen picker
        ...
        reasenSprinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(addAppointment.this, "your choice is " + reasenChoice, Toast.LENGTH_SHORT).show();
            }
            @Override
            public void onNothingSelected(AdapterView<?> parent) {
                // TODO Auto-generated method stub
